$(document).ready(function () {
    dashboard_A_chart2.chartVisit();
    dashboard_A_chart2.sparkLine();
...
dashboard_A_chart2 = {
    ...
    chartVisit: function () {
        var elem = $('#dashChartVisitors2');
        var elemo = $('#dashChartVisitorsOverview2');
...
*/
        ...
        $("#setLastSevenDays2").click(function () {
            plot.setSelection({
                xaxis: {
                    from: 1203289200000,
                    to: 1203894000000
        ...
        $("#setLastFortnight2").click(function () {
            plot.setSelection({
                xaxis: {
                    from: 1202684400000,
                    to: 1203894000000
