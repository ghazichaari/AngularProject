$(document).ready(function () {
    var d1 = [
            [1196463600000, 1], [1196550000000, 10], [1196636400000, 68], [1196722800000, 127], [1196809200000, 136], [1196895600000, 175], [1196982000000, 236],
    ...
    dashboard_A_chart1.chartVisit(d1);
    dashboard_A_chart1.sparkLine();

//    setTimeout(function () {
//        $.gritter.add({
//            title: 'Welcome back our product cursen is the best <br /> so  easy to check your consumption',
//            text: ' <strong>Have a nice day </strong>',
//            sticky: false,
//           
//            time: 7000
//        });
...
dashboard_A_chart1 = {
    ...
    chartVisit: function (d1) {
        var elem = $('#dashChartVisitors1');
        var elemo = $('#dashChartVisitorsOverview1');
...
*/
        ...
        $("#setLastSevenDays1").click(function () {
            plot.setSelection({
                xaxis: {
                    from: 1203289200000,
                    to: 1203894000000
        ...
        $("#setLastFortnight1").click(function () {
            plot.setSelection({
                xaxis: {
                    from: 1202684400000,
                    to: 1203894000000
